...
def main():
    os.system('cls')
    astraahometitle()     
    print(f"""              {Fore.WHITE}[{Fore.WHITE}01{Fore.WHITE}] RAT Tool                     {Fore.WHITE}[{Fore.WHITE}06{Fore.WHITE}] Token Grabber""")
    print(f"""              {Fore.WHITE}[{Fore.WHITE}02{Fore.WHITE}] Discord Nuker                {Fore.WHITE}[{Fore.WHITE}07{Fore.WHITE}] Token Generator""")
    print(f"""              {Fore.WHITE}[{Fore.WHITE}03{Fore.WHITE}] WebHooks Remover             {Fore.WHITE}[{Fore.WHITE}08{Fore.WHITE}] Nitro Generator""")
    print(f"""              {Fore.WHITE}[{Fore.WHITE}04{Fore.WHITE}] Massive Report               {Fore.WHITE}[{Fore.WHITE}09{Fore.WHITE}] Token Rape""")
    print(f"""              {Fore.WHITE}[{Fore.WHITE}05{Fore.WHITE}] Webhook Spam                 {Fore.WHITE}[{Fore.WHITE}10{Fore.WHITE}] Token Informations""")
    print(f"""                                                                                                        """)

os.system(f'cls & mode 85,20 & title Zolo Nuker - Configuration')

print(f"""\n{Fore.LIGHTWHITE_EX }{Fore.LIGHTWHITE_EX }{Fore.LIGHTWHITE_EX }Enter your bots token here!: """)
...
def RichPresence():
    if rich_presence == "y" or rich_presence == "Y":
        try:
            ...
            RPC.connect() 
            RPC.update(details="Connected", large_image="zololarge2", small_image="Zolo", large_text="https://discord.gg/Z2DBDcVrxt", start=time.time())
        except:
            pass
...
class Nuker:
    ...
    def Credits(self):
        os.system(f'cls & mode 85,20 & title Zolo nuker - Credits')
        print(f'''
                         {self.colour}╔═╗╔═╗╦  ╔═╗  ╔╗╔╦ ╦╦╔═╔═╗╦═╗
                         \033[90m╔═╝║ ║║  ║ ║  ║║║║ ║╠╩╗║╣ ╠╦╝
                         \033[37m╚═╝╚═╝╩═╝╚═╝  ╝╚╝╚═╝╩ ╩╚═╝╩╚═\n\n

                              {self.colour}[\033[37mGithub{self.colour}]  \033[37mZolo Tool
                              {self.colour}[\033[37mServer{self.colour}]  \033[37mhttps://discord.gg/Z2DBDcVrxt
                              {self.colour}[\033[37mDiscord{self.colour}] \033[37mzolo#5269
    \033[37m''')

    async def ThemeChanger(self):
        os.system(f'cls & mode 85,20 & title Zolo nuker - Themes')
        print(f'''
                         {self.colour}╔═╗╔═╗╦  ╔═╗  ╔╗╔╦ ╦╦╔═╔═╗╦═╗
                         \033[90m╔═╝║ ║║  ║ ║  ║║║║ ║╠╩╗║╣ ╠╦╝
                         \033[37m╚═╝╚═╝╩═╝╚═╝  ╝╚╝╚═╝╩ ╩╚═╝╩╚═\n\n
    ...
    async def Menu(self):
        os.system(f'cls & mode 85,20 & title [Zolo Nuker] - Connected: {client.user}')
        print(f'''
                         {self.colour}╔═╗╔═╗╦  ╔═╗  ╔╗╔╦ ╦╦╔═╔═╗╦═╗
                         \033[90m╔═╝║ ║║  ║ ║  ║║║║ ║╠╩╗║╣ ╠╦╝
                         \033[37m╚═╝╚═╝╩═╝╚═╝  ╝╚╝╚═╝╩ ╩╚═╝╩╚═\n\n
    ...
    def Startup(self):
        try:
            ...
            print(f"""{Fore.LIGHTWHITE_EX }[{Fore.LIGHTRED_EX }#{Fore.LIGHTWHITE_EX }] Invalid Bot Token""")
            input()
            main()
